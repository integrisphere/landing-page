  ...
  const services = [
    {
      ...
      description:
        "Comprehensive solutions for pipeline asset management and integrity assurance.",
      features: [
      ...
      aiIntegration:
        "Our AI continuously analyzes inline inspection data, corrosion probe readings, and SCADA inputs to predict areas of concern months in advance, reducing false alarms and enabling real-time leak detection.",
      benefits: [
        "Up to 50% reduction in unnecessary inspections",
        "Up to 30% chemical cost savings",
    ...
    },
    {
      ...
      description:
        "National Board, API certified inspection programs for critical pressure equipment.",
      features: [
      ...
      aiIntegration:
        "Historical reports and photos are analyzed with machine vision to detect wear patterns or damage growth over time, leading to proactive repairs and optimized shutdown intervals.",
      benefits: [
        "Extended asset life",
        "Avoided unplanned shutdowns",
        "Millions saved in repair costs",
      ],
    },
    {
      id: "boiler",
      ...
      description:
        "Advanced analysis and optimization for boiler systems and heat recovery equipment.",
      features: [
      ...
      aiIntegration:
        "Real-time chemical data is continuously analyzed by machine learning models to predict scaling trends, optimize cleaning schedules, and proactively protect critical components—extending the life of HRSGs and boilers, boosting efficiency, and dramatically reducing fuel consumption.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Advanced aerial inspections and corrosion under insulation detection services.",
      features: [
      ...
      aiIntegration:
        "Each drone image is analyzed in real-time by our system to detect minute changes in heat signatures and surface textures indicative of corrosion, with AI highlighting regions with anomaly patterns not visible to the human eye.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Comprehensive corrosion assessment and mitigation planning services.",
      features: [
      ...
      aiIntegration:
        "SLMs evaluate data from different corrosion methods to recommend adjustments in inhibitors or pigging frequency, saving cost and preventing leaks through intelligent analysis of multiple data streams.",
      benefits: [
        "Prevented leaks",
    ...
    },
    {
      ...
      description:
        "Comprehensive engineering solutions with AI-enhanced analysis and optimization capabilities.",
      features: [
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="max-w-4xl text-primary-foreground text-center">
            ...
            <p className="text-xl md:text-2xl text-primary-foreground/90 max-w-3xl mx-auto leading-relaxed mb-8">
              Every service enhanced with custom AI solutions for superior
              decision-making, cost reduction, and enhanced safety across global
              operations.
            </p>
            <Button
              variant="premium"
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-primary-foreground/90">
            Our AI-enhanced services have helped clients save millions while
