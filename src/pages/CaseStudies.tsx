  ...
  const caseStudies = [
    {
      ...
      challenge: "A large power plant was experiencing excessive chemical costs and scaling issues in their boiler feedwater system, leading to frequent cleaning cycles and reduced efficiency.",
      solution: "Implemented our AI-powered Boiler Performance Predictor™ to analyze real-time water chemistry data and optimize chemical dosing rates while predicting scaling trends.",
      implementation: [
    ...
    },
    {
      ...
      industry: "Oil & Gas",
      challenge: "A major pipeline operator faced recurring leak incidents costing millions in environmental cleanup, regulatory fines, and lost production.",
      solution: "Deployed our Leak Pattern Identifier™ AI system with smart pigging integration and real-time corrosion monitoring to predict leak locations before failures occur.",
      implementation: [
    ...
    },
    {
      ...
      challenge: "Critical pressure vessels were approaching end-of-life with potential replacement costs exceeding $5M, threatening production continuity.",
      solution: "Applied our Degradation Trend Analyzer™ with fitness-for-service assessments to safely extend vessel life while maintaining compliance.",
      implementation: [
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="space-y-20">
            {caseStudies.map((study, index) => (
              <div key={study.id} className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-start ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}>
                <div className={`space-y-6 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                  ...
                  <div className="bg-card border border-border rounded-lg p-6 shadow-medium">
                    ...
                    <h4 className="text-lg font-medium text-foreground mb-3">Implementation Steps:</h4>
                  ...
                  <div className="bg-success/10 border border-success/20 rounded-lg p-6">
                    <h3 className="text-xl font-semibold text-success mb-4">Key Results</h3>
                    ...
                    <div className="text-center space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-primary-foreground/10 rounded-lg p-4 backdrop-blur-sm">
                          <div className="text-2xl font-bold text-accent">{study.results.savings}</div>
                          <div className="text-sm text-primary-foreground/80">Total Savings</div>
                        </div>
                        <div className="bg-primary-foreground/10 rounded-lg p-4 backdrop-blur-sm">
                          <div className="text-2xl font-bold text-accent">{study.results.efficiency}</div>
                          <div className="text-sm text-primary-foreground/80">Efficiency Gain</div>
                        </div>
                        <div className="bg-primary-foreground/10 rounded-lg p-4 backdrop-blur-sm">
                          <div className="text-2xl font-bold text-accent">{study.results.reduction}</div>
                          <div className="text-sm text-primary-foreground/80">Cost Reduction</div>
                        </div>
                        <div className="bg-primary-foreground/10 rounded-lg p-4 backdrop-blur-sm">
                          <div className="text-2xl font-bold text-accent">{study.results.timeframe}</div>
                          <div className="text-sm text-primary-foreground/80">Implementation</div>
                        </div>
                      </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-6">Why Our Clients Succeed</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our proven methodology and cutting-edge AI technology consistently deliver 
              exceptional results across industries and applications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card border border-border rounded-lg p-8 shadow-medium text-center">
              ...
              <p className="text-muted-foreground">
                Every recommendation backed by comprehensive data analysis and AI-powered insights.
              </p>
            </div>
            <div className="bg-card border border-border rounded-lg p-8 shadow-medium text-center">
              <Clock className="h-12 w-12 text-accent mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-foreground mb-3">Rapid Implementation</h3>
              <p className="text-muted-foreground">
                Streamlined deployment process ensures quick time-to-value and immediate impact.
              </p>
            </div>
            <div className="bg-card border border-border rounded-lg p-8 shadow-medium text-center">
              <Shield className="h-12 w-12 text-accent mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-foreground mb-3">Continuous Support</h3>
              <p className="text-muted-foreground">
                Ongoing monitoring and optimization ensure sustained performance improvements.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Join industry leaders who have transformed their operations with IntegriSphere Solutions. 
